...
public abstract class InputParser
{
	...
	public abstract static class StringInputParser extends InputParser
	{
		...
		public void parse()
		{
            ...
            else if (input.startsWith("bitid:"))
            {
                try
                {
                ...
                {
                    log.info("got invalid bitid uri: '" + input + "'", x);
	...
	public abstract static class BinaryInputParser extends InputParser
	{
		...
		public void parse()
		{
			...
			else if (com.google.bitcoin.protocols.payments.PaymentProtocol.MIMETYPE_PAYMENTREQUEST.equals(inputType))
			{
				try
				{
	...
	public abstract static class StreamInputParser extends InputParser
	{
		...
		public void parse()
		{
			if (com.google.bitcoin.protocols.payments.PaymentProtocol.MIMETYPE_PAYMENTREQUEST.equals(inputType))
			{
